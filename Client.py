...
class Client:
	...
	def createWidgets(self):
		...
		# Create Play button	
		self.start = customtkinter.CTkButton(master=self.master,fg_color=("green"),text="PLAY",corner_radius=16, command=self.setupMovie)#lambda : [self.setupMovie(), self.playMovie()])
		...
		self.label = Label(self.master, height=19, width=20)
	...
	def setupMovie(self):
		...
		if self.state == self.INIT: self.openRtpPort(), self.sendRtspRequest(self.SETUP)
